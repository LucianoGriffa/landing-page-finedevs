...
const HomePage = () => {
  ...
  <section id='home' className="w-full h-screen flex min-xl:flex-row bg-finedevs-black p-0 m-0 min-xl:absolute">
    ...
    <div className="w-full flex flex-col justify-center items-center gap-4 max-md:gap-6 text-center mt-10">
      <p className="font-extrabold text-white max-md:text-5xl max-sm:text-4xl text-7xl">Obtén <br /> Desarrollo<br /> de <br /> Software<br /><span className="text-finedevs-red">Avanzado<br /></span></p>
      <p className="w-5/6 lg:w-full font-normal text-finedevs-grey max-md:text-sm text-md">Nos destacamos por utilizar las mejores tecnologías del mercado, asegurando un desempeño sobresaliente y resultados garantizados.</p>
