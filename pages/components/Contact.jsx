  ...
  return (
    <section id="contact" className="w-full h-screen flex flex-col justify-center items-center">
      <div className="w-3/4 flex flex-col text-center justify-center items-center border border-finedevs-white p-5 sm:p-10 md:p-20 lg:p-28 xl:p-36 rounded-3xl gap-6">
        <p className="font-extrabold text-white text-4xl md:text-5xl lg:text-5xl xl:text-6xl">Let's discuss the <span className="text-finedevs-red">idea</span>.</p>
        <p className="w-5/6 xl:w-4/6 font-normal text-finedevs-gray">Leave us your contact email, and we'll get in touch shortly to discuss your requirements and find the perfect solution for you.</p>
